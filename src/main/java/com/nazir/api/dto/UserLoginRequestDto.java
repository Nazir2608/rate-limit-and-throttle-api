...
public class UserLoginRequestDto {
	...
	@Schema(requiredMode = RequiredMode.REQUIRED, example = "nazir2686@gmail.com", description = "email-id associated with user account already created in the system")
